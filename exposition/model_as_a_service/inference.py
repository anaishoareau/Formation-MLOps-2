...
def predict_endpoint():
    ...
    {"Wind_turbine_name": "R80721", "Date_time": "2017-02-08T08:00:00+01:00", "Ba_avg": 44.99, "Ba_min": 44.99,
     "Ba_max": input_data, "Ba_std": 0.0, "Rt_avg": 14.0, "Rt_min": 14.0, "Rt_max": 14.0, "Rt_std": 0.0,
    ...
    prepared_features = prepare_features(received_data_df,training_mode=False)
    predictions = predict(prepared_features, config.MODEL_PATH)
